...
const LoginHeader: FC<ILoginHeaderProps> = ({ isNewUser }) => {
	...
	return (
		<>
			<div className='text-start h3 fw-bold mt-3'>Welcome, to Amypo</div>
			<div className='text-start h6 text-muted mb-4 mt-2'>Please, Sign in to continue!</div>
		</>
	);
};
